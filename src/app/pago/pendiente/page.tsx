    ...
    <AppShell>
      <main className="flex min-h-[70vh] items-center justify-center px-5 py-20">
        <PremiumCard className="max-w-xl p-8 text-center">
          <h1 className="font-display text-3xl font-extrabold text-[#1d1d1f]">Pago pendiente</h1>
          <p className="mt-4 text-[15px] leading-relaxed text-[#6e6e73]">
            Tu pago está pendiente de confirmación. Cuando el proveedor lo apruebe, tu participación se activará automáticamente.
          </p>
